...
<div class="front-module" style="width:100%">
    <table width="100%" cellpadding="1" class="listtable">
        ...
        <tr height="16">
            <td width="16" class="listtable_top">{'general.mod'|t}</td>
            <td width="24%" class="listtable_top" align="center"><strong>{'general.datetime'|t}</strong></td>
            <td class="listtable_top"><strong>{'general.name'|t}</strong></td>
            <td width="14%" class="listtable_top"><strong>{'general.length'|t}</strong></td>
        </tr>
...
<div class="front-module dashboard-ban-blocks">
    <table width="100%" cellpadding="1" class="listtable">
        <tr>
            <td colspan="3">
                <table width="100%" cellpadding="0" cellspacing="0" class="front-module-header">
                    <tr>
                        <td align="left">
                            {'dashboard.latest.players.blocked'|t}
                        </td>
                        <td align="right">
                            {'dashboard.total.blocked'|t:$total_blocked}
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            ...
            <td height="25%" class="listtable_top dashboard-ban-block-date"><b>{'general.datetime'|t}</b></td>
            <td height="16" class="listtable_top"><b>{'general.name'|t}</b></td>
        </tr>
...
<div class="front-module dashboard-comm-blocks">
    <table width="100%" cellpadding="1" class="listtable">
        ...
        <tr height="16">
            <td width="16" class="listtable_top">{'dashboard.comm.blocks.type'|t}</td>
            <td width="24%" class="listtable_top" align="center"><strong>{'general.datetime'|t}</strong></td>
            <td class="listtable_top"><strong>{'general.name'|t}</strong></td>
            <td width="23%" class="listtable_top"><strong>{'general.length'|t}</strong></td>
        </tr>
